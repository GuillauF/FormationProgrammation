...
//étant donné qu'un fichier php interprété renvoie toujours du texte, pour afficher quelque chose à l'écran, il faut pouvoir dicter à PHP de renvoyer du texte à l'exécution
//pour ça, on peut utiliser la fonction echo
echo $message;

//les conditions suivent les mêmes principes et (presque) syntaxes qu'en javascript
$age = 11;
//cette condition sera toujours vraie, c'est pour l'exemple
if ($age < 18){
    //Etant donné qu'on renvoie du texte, on peut très bien écrire des balises HTML qui seront interprétées par le navigateur
...
//attention : count() ne sert qu'aux tableaux et pas aux chaînes de caractères
...
echo $villes["34000"];
//les données de notre tableau associatif sont acessibles par des clés, mais par conséquent ne le sont plus à l'aide d'indices (0, 1, 2 ...)
